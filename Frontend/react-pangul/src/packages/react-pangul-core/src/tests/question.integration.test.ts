...
test("test create new answer", (done) => {
    (async () => {
...
test("test get existing answer", (done) => {
    (async () => {
        await IntegrationTestFixture.get().withAuth("admin", "admin", async (user) => {
            const question = new Question();
            await question.update(async () => {
...
test("test search in topic for answer", (done) => {
    (async () => {
        await IntegrationTestFixture.get().withAuth("admin", "admin", async (user) => {
            const question = new Question();
            await question.update(async () => {
...
test("test search in any topic for answer", (done) => {
    (async () => {
        await IntegrationTestFixture.get().withAuth("admin", "admin", async (user) => {
            const question = new Question();
            await question.update(async () => {
...
test("test move answer to new topic", (done) => {
    (async () => {
        await IntegrationTestFixture.get().withAuth("admin", "admin", async (user) => {
            // Create
            const question = new Question();
