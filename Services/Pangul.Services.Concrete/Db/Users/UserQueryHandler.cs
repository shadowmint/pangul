...
{
    public class UserQueryHandler : IQueryHandler<GetUserDetails, User>, IQueryHandler<GetUserContact, UserContact>, IQueryHandler<GetAllLoginUsernames, IEnumerable<IQueryable<string>>>
    {
